  ...
  return (
    <div className='container mx-auto p-4 max-w-2xl'>
      <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6'>
        <div className='mb-6'>
          <h2 className='text-2xl font-bold dark:text-white'>회원 정보</h2>
        </div>
        <div className='space-y-4'>
          <div className='grid grid-cols-3 gap-4'>
            ...
            <div className='font-semibold dark:text-gray-200'>가입일</div>
            <div className='col-span-2 dark:text-gray-300'>{formatDate(loginMember.createdAt)}</div>
